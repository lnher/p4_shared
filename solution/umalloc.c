...
static Header* morecore(uint nu, int use_huge_pages) {
  ...
  //printf(1, "morecore: use_huge_pages = %d, n = %d\n", use_huge_pages, nu*sizeof(Header));
...
normalmalloc(uint nbytes, int use_huge_pages)
{
  ...
  //printf(1, "normalmalloc: use_huge_pages = %d, n = %d\n", use_huge_pages, nunits);
...
void* vmalloc(uint nbytes, int pagesize) {
  ...
  //printf(1, "%d and %d", nbytes, pagesize);
