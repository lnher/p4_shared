...
main(int argc, char **argv)
{
  ...
  7e:	83 c3 01             	add    $0x1,%ebx
    kill(atoi(argv[i]));
  81:	e8 0a 02 00 00       	call   290 <atoi>
  86:	89 04 24             	mov    %eax,(%esp)
  89:	e8 a5 02 00 00       	call   333 <kill>
  for(i=1; i<argc; i++)
  8e:	83 c4 10             	add    $0x10,%esp
  91:	39 de                	cmp    %ebx,%esi
  93:	75 e3                	jne    78 <main+0x28>
  exit();
  95:	e8 69 02 00 00       	call   303 <exit>
    printf(2, "usage: kill pid...\n");
  9a:	50                   	push   %eax
  9b:	50                   	push   %eax
  9c:	68 84 08 00 00       	push   $0x884
  a1:	6a 02                	push   $0x2
  a3:	e8 d8 03 00 00       	call   480 <printf>
    exit();
  a8:	e8 56 02 00 00       	call   303 <exit>
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 f8 08 00 00 	movzbl 0x8f8(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 a0 08 00 00 	jmp    *0x8a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 98 08 00 00       	mov    $0x898,%edx
        while(*s != 0){
...
void vfree(void *ap, int use_huge_pages) {
 ...
 634:	0f 84 96 00 00 00    	je     6d0 <vfree+0xb0>
        freepptr = &huge_freep;
 63a:	a1 20 0c 00 00       	mov    0xc20,%eax
 63f:	bf 20 0c 00 00       	mov    $0xc20,%edi
 ...
 6cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        freepptr = &freep;
 6d0:	a1 2c 0c 00 00       	mov    0xc2c,%eax
 6d5:	bf 2c 0c 00 00       	mov    $0xc2c,%edi
    for (p = *freepptr; !(bp > p && bp < p->s.ptr); p = p->s.ptr) {
...
void* vmalloc(uint nbytes, int use_huge_pages) {
 ...
 6ee:	0f 84 0c 01 00 00    	je     800 <vmalloc+0x120>
        if ((prevp = huge_freep) == 0) {
 6f4:	8b 15 20 0c 00 00    	mov    0xc20,%edx
 ...
 75f:	39 05 2c 0c 00 00    	cmp    %eax,0xc2c
 ...
 791:	8b 15 20 0c 00 00    	mov    0xc20,%edx
 ...
 7cf:	e8 4c fe ff ff       	call   620 <vfree>
  return use_huge_pages ? huge_freep : freep;
 7d4:	8b 15 2c 0c 00 00    	mov    0xc2c,%edx
 ...
 7ec:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 7ef:	89 15 2c 0c 00 00    	mov    %edx,0xc2c
}
 ...
 7ff:	c3                   	ret    
        if ((prevp = freep) == 0) {
 800:	8b 15 2c 0c 00 00    	mov    0xc2c,%edx
