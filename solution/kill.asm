 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 bc 0a 00 00 	movzbl 0xabc(%edx),%edx
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4a9:	ff 24 85 64 0a 00 00 	jmp    *0xa64(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 5c 0a 00 00       	mov    $0xa5c,%edx
        while(*s != 0){
...
normalfree(void *ap)
{
 ...
 5d1:	a1 e4 0e 00 00       	mov    0xee4,%eax
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	89 15 e4 0e 00 00    	mov    %edx,0xee4
}
 618:	5e                   	pop    %esi
 619:	5f                   	pop    %edi
 61a:	5d                   	pop    %ebp
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 e4 0e 00 00    	mov    %edx,0xee4
    p->s.size += bp->s.size;
...
hugefree(void *ap)
{
 ...
 661:	a1 d8 0e 00 00       	mov    0xed8,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  huge_freep = p;
 6a2:	89 15 d8 0e 00 00    	mov    %edx,0xed8
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  huge_freep = p;
 6dc:	89 15 d8 0e 00 00    	mov    %edx,0xed8
    p->s.size += bp->s.size;
...
000006f0 <hugemalloc>:
{
 ...
 6fc:	8b 3d d8 0e 00 00    	mov    0xed8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 747:	73 77                	jae    7c0 <hugemalloc+0xd0>
    if(p == huge_freep)
 749:	8b 0d d8 0e 00 00    	mov    0xed8,%ecx
...
void vfree(void *ap) {
 ...
 784:	83 c4 10             	add    $0x10,%esp
    return huge_freep;
 787:	8b 15 d8 0e 00 00    	mov    0xed8,%edx
 78d:	85 db                	test   %ebx,%ebx
 78f:	0f 44 15 e4 0e 00 00 	cmove  0xee4,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      huge_freep = prevp;
 7cf:	89 15 d8 0e 00 00    	mov    %edx,0xed8
}
 ...
 7e0:	c7 05 d8 0e 00 00 dc 	movl   $0xedc,0xed8
 7e7:	0e 00 00 
    huge_base.s.size = 0;
 7ea:	bf dc 0e 00 00       	mov    $0xedc,%edi
    huge_base.s.ptr = huge_freep = prevp = &huge_base;
 7ef:	c7 05 dc 0e 00 00 dc 	movl   $0xedc,0xedc
 7f6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    huge_base.s.size = 0;
 7fb:	c7 05 e0 0e 00 00 00 	movl   $0x0,0xee0
 802:	00 00 00 
    if(p->s.size >= nunits){
...
00000820 <normalmalloc>:
{
 ...
 829:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 82c:	8b 3d e4 0e 00 00    	mov    0xee4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 877:	73 77                	jae    8f0 <normalmalloc+0xd0>
    if(p == freep) {
 879:	8b 0d e4 0e 00 00    	mov    0xee4,%ecx
 ...
 8b4:	83 c4 10             	add    $0x10,%esp
    return huge_freep;
 8b7:	8b 15 d8 0e 00 00    	mov    0xed8,%edx
 8bd:	85 db                	test   %ebx,%ebx
 8bf:	0f 44 15 e4 0e 00 00 	cmove  0xee4,%edx
      if((p = morecore(nunits, use_huge_pages)) == 0) {
 ...
 8fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8ff:	89 15 e4 0e 00 00    	mov    %edx,0xee4
}
 ...
 910:	c7 05 e4 0e 00 00 e8 	movl   $0xee8,0xee4
 917:	0e 00 00 
    base.s.size = 0;
 91a:	bf e8 0e 00 00       	mov    $0xee8,%edi
    base.s.ptr = freep = prevp = &base;
 91f:	c7 05 e8 0e 00 00 e8 	movl   $0xee8,0xee8
 926:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 929:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 92b:	c7 05 ec 0e 00 00 00 	movl   $0x0,0xeec
 932:	00 00 00 
    if(p->s.size >= nunits){
