...
00000000 <vmalloc.cold>:
   ...
   0:	c7 05 60 0c 00 00 64 	movl   $0xc64,0xc60
   7:	0c 00 00 
   a:	c7 05 64 0c 00 00 64 	movl   $0xc64,0xc64
  11:	0c 00 00 
            huge_base.s.size = 0;
  14:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
  1b:	00 00 00 
        //freepptr = &freep;
    }
  ...
  25:	c7 05 6c 0c 00 00 70 	movl   $0xc70,0xc6c
  2c:	0c 00 00 
  2f:	c7 05 70 0c 00 00 70 	movl   $0xc70,0xc70
  36:	0c 00 00 
            base.s.size = 0;
  39:	c7 05 74 0c 00 00 00 	movl   $0x0,0xc74
  40:	00 00 00 
...
main(int argc, char *argv[])
{
  ...
  83:	ff 33                	push   (%ebx)
  85:	e8 01 03 00 00       	call   38b <mkdir>
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 38 09 00 00 	movzbl 0x938(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 e0 08 00 00 	jmp    *0x8e0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba d7 08 00 00       	mov    $0x8d7,%edx
        while(*s != 0){
...
void vfree(void *ap, int use_huge_pages) {
 ...
 654:	0f 84 96 00 00 00    	je     6f0 <vfree+0xb0>
        freepptr = &huge_freep;
 65a:	a1 60 0c 00 00       	mov    0xc60,%eax
 65f:	bf 60 0c 00 00       	mov    $0xc60,%edi
 ...
 6ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        freepptr = &freep;
 6f0:	a1 6c 0c 00 00       	mov    0xc6c,%eax
 6f5:	bf 6c 0c 00 00       	mov    $0xc6c,%edi
    for (p = *freepptr; !(bp > p && bp < p->s.ptr); p = p->s.ptr) {
...
void* vmalloc(uint nbytes, int use_huge_pages) {
 ...
 70e:	0f 84 0c 01 00 00    	je     820 <vmalloc+0x120>
        if ((prevp = huge_freep) == 0) {
 714:	8b 15 60 0c 00 00    	mov    0xc60,%edx
 ...
 77f:	39 05 6c 0c 00 00    	cmp    %eax,0xc6c
 ...
 7b1:	8b 15 60 0c 00 00    	mov    0xc60,%edx
 ...
 7ef:	e8 4c fe ff ff       	call   640 <vfree>
  return use_huge_pages ? huge_freep : freep;
 7f4:	8b 15 6c 0c 00 00    	mov    0xc6c,%edx
 ...
 81f:	c3                   	ret    
        if ((prevp = freep) == 0) {
 820:	8b 15 6c 0c 00 00    	mov    0xc6c,%edx
