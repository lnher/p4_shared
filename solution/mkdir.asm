 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 fc 0a 00 00 	movzbl 0xafc(%edx),%edx
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 a4 0a 00 00 	jmp    *0xaa4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 9b 0a 00 00       	mov    $0xa9b,%edx
        while(*s != 0){
...
normalfree(void *ap)
{
 ...
 5f1:	a1 24 0f 00 00       	mov    0xf24,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 24 0f 00 00    	mov    %edx,0xf24
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 24 0f 00 00    	mov    %edx,0xf24
    p->s.size += bp->s.size;
...
hugefree(void *ap)
{
 ...
 681:	a1 18 0f 00 00       	mov    0xf18,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  huge_freep = p;
 6c2:	89 15 18 0f 00 00    	mov    %edx,0xf18
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  huge_freep = p;
 6fc:	89 15 18 0f 00 00    	mov    %edx,0xf18
    p->s.size += bp->s.size;
...
00000710 <hugemalloc>:
{
 ...
 71c:	8b 3d 18 0f 00 00    	mov    0xf18,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 767:	73 77                	jae    7e0 <hugemalloc+0xd0>
    if(p == huge_freep)
 769:	8b 0d 18 0f 00 00    	mov    0xf18,%ecx
...
void vfree(void *ap) {
 ...
 7a4:	83 c4 10             	add    $0x10,%esp
    return huge_freep;
 7a7:	8b 15 18 0f 00 00    	mov    0xf18,%edx
 7ad:	85 db                	test   %ebx,%ebx
 7af:	0f 44 15 24 0f 00 00 	cmove  0xf24,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      huge_freep = prevp;
 7ef:	89 15 18 0f 00 00    	mov    %edx,0xf18
}
 ...
 800:	c7 05 18 0f 00 00 1c 	movl   $0xf1c,0xf18
 807:	0f 00 00 
    huge_base.s.size = 0;
 80a:	bf 1c 0f 00 00       	mov    $0xf1c,%edi
    huge_base.s.ptr = huge_freep = prevp = &huge_base;
 80f:	c7 05 1c 0f 00 00 1c 	movl   $0xf1c,0xf1c
 816:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    huge_base.s.size = 0;
 81b:	c7 05 20 0f 00 00 00 	movl   $0x0,0xf20
 822:	00 00 00 
    if(p->s.size >= nunits){
...
00000840 <normalmalloc>:
{
 ...
 897:	73 77                	jae    910 <normalmalloc+0xd0>
    if(p == freep) {
 899:	8b 0d 24 0f 00 00    	mov    0xf24,%ecx
 ...
 8d4:	83 c4 10             	add    $0x10,%esp
    return huge_freep;
 8d7:	8b 15 18 0f 00 00    	mov    0xf18,%edx
 8dd:	85 db                	test   %ebx,%ebx
 8df:	0f 44 15 24 0f 00 00 	cmove  0xf24,%edx
      if((p = morecore(nunits, use_huge_pages)) == 0) {
 ...
 91c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 91f:	89 15 24 0f 00 00    	mov    %edx,0xf24
}
 ...
 930:	c7 05 24 0f 00 00 28 	movl   $0xf28,0xf24
 937:	0f 00 00 
    base.s.size = 0;
 93a:	bf 28 0f 00 00       	mov    $0xf28,%edi
    base.s.ptr = freep = prevp = &base;
 93f:	c7 05 28 0f 00 00 28 	movl   $0xf28,0xf28
 946:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 949:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 94b:	c7 05 2c 0f 00 00 00 	movl   $0x0,0xf2c
 952:	00 00 00 
    if(p->s.size >= nunits){
