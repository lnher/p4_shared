...
main(int argc, char *argv[])
{
  ...
  50:	68 ef 09 00 00       	push   $0x9ef
  55:	50                   	push   %eax
  56:	68 ea 09 00 00       	push   $0x9ea
  5b:	6a 01                	push   $0x1
 ...
 39c:	89 d1                	mov    %edx,%ecx
{
 ...
 3c9:	0f b6 92 50 0a 00 00 	movzbl 0xa50(%edx),%edx
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4b9:	ff 24 85 f8 09 00 00 	jmp    *0x9f8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba f1 09 00 00       	mov    $0x9f1,%edx
        while(*s != 0){
...
normalfree(void *ap)
{
 ...
 5e1:	a1 9c 0e 00 00       	mov    0xe9c,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 9c 0e 00 00    	mov    %edx,0xe9c
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 9c 0e 00 00    	mov    %edx,0xe9c
    p->s.size += bp->s.size;
...
hugefree(void *ap)
{
 ...
 671:	a1 90 0e 00 00       	mov    0xe90,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  huge_freep = p;
 6b2:	89 15 90 0e 00 00    	mov    %edx,0xe90
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  huge_freep = p;
 6ec:	89 15 90 0e 00 00    	mov    %edx,0xe90
    p->s.size += bp->s.size;
...
static Header* morecore(uint nu, int use_huge_pages) {
 ...
 709:	74 45                	je     750 <morecore+0x50>
 ...
 718:	52                   	push   %edx
 719:	8d 04 cd 00 00 00 00 	lea    0x0(,%ecx,8),%eax
 ...
 72e:	74 68                	je     798 <morecore+0x98>
  hp->s.size = nu;
...
void vfree(void *ap, int use_huge_pages) {
 ...
 736:	83 c0 08             	add    $0x8,%eax
    hugefree(ap);
 739:	50                   	push   %eax
 73a:	e8 31 ff ff ff       	call   670 <hugefree>
    return huge_freep;
 73f:	a1 90 0e 00 00       	mov    0xe90,%eax
}
 ...
 74c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(nu < 4096)
 750:	ba 00 10 00 00       	mov    $0x1000,%edx
 755:	39 d0                	cmp    %edx,%eax
 757:	89 d3                	mov    %edx,%ebx
 759:	0f 43 d8             	cmovae %eax,%ebx
  p = sbrk(nu * sizeof(Header), use_huge_pages);
 75c:	83 ec 08             	sub    $0x8,%esp
 75f:	6a 00                	push   $0x0
 761:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 768:	50                   	push   %eax
 769:	e8 dd fb ff ff       	call   34b <sbrk>
  if(p == (char*)-1)
 76e:	83 c4 10             	add    $0x10,%esp
 771:	83 f8 ff             	cmp    $0xffffffff,%eax
 774:	74 22                	je     798 <morecore+0x98>
  hp->s.size = nu;
 ...
 77c:	83 c0 08             	add    $0x8,%eax
    normalfree(ap);
 77f:	50                   	push   %eax
 780:	e8 5b fe ff ff       	call   5e0 <normalfree>
    return freep;
 785:	a1 9c 0e 00 00       	mov    0xe9c,%eax
}
 78a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    return freep;
...
000007a0 <normalmalloc>:
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d 9c 0e 00 00    	mov    0xe9c,%edi
{
 ...
 7d7:	73 27                	jae    800 <normalmalloc+0x60>
    if(p == freep) {
 7d9:	8b 3d 9c 0e 00 00    	mov    0xe9c,%edi
 ...
 7e9:	e8 12 ff ff ff       	call   700 <morecore>
 ...
 80c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 80f:	a3 9c 0e 00 00       	mov    %eax,0xe9c
}
 ...
 820:	c7 05 9c 0e 00 00 a0 	movl   $0xea0,0xe9c
 827:	0e 00 00 
    base.s.size = 0;
 82a:	bf a0 0e 00 00       	mov    $0xea0,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 a0 0e 00 00 a0 	movl   $0xea0,0xea0
 836:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 a4 0e 00 00 00 	movl   $0x0,0xea4
 842:	00 00 00 
    if(p->s.size >= nunits){
...
00000860 <hugemalloc>:
{
 ...
 86c:	8b 3d 90 0e 00 00    	mov    0xe90,%edi
{
 ...
 897:	73 27                	jae    8c0 <hugemalloc+0x60>
    if(p == huge_freep)
 899:	8b 3d 90 0e 00 00    	mov    0xe90,%edi
 ...
 8a9:	e8 52 fe ff ff       	call   700 <morecore>
 ...
 8cc:	89 72 04             	mov    %esi,0x4(%edx)
      huge_freep = prevp;
 8cf:	a3 90 0e 00 00       	mov    %eax,0xe90
}
...
void* vmalloc(uint nbytes, int pagesize) {
 ...
 955:	50                   	push   %eax
 956:	50                   	push   %eax
 957:	68 64 0a 00 00       	push   $0xa64
 95c:	6a 01                	push   $0x1
 95e:	e8 dd fa ff ff       	call   440 <printf>
    exit();
 963:	e8 5b f9 ff ff       	call   2c3 <exit>
...
void vfree(void *ap, int use_huge_pages) {
 ...
 97a:	5d                   	pop    %ebp
    hugefree(ap);
 97b:	e9 f0 fc ff ff       	jmp    670 <hugefree>
}
 980:	5d                   	pop    %ebp
    normalfree(ap);
 981:	e9 5a fc ff ff       	jmp    5e0 <normalfree>
...
void* malloc(uint nbytes){
 ...
 997:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int thp = getthp();
 99a:	e8 dc f9 ff ff       	call   37b <getthp>
...
000009e0 <free>:
    normalfree(ap);
 9e0:	e9 fb fb ff ff       	jmp    5e0 <normalfree>
